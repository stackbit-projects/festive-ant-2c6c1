    ...
    plugins: [
        {
            ...
            options: {
                ...
                projectId: process.env.SANITY_PROJECT_ID || 'dtqjng8f',
        ...
        },
        {
            ...
            options: {
                ...
                commonProps: (items) => {
                    return {
                        pages: _.filter(items, item => ["advanced","page","post"].includes(_.get(item, '__metadata.modelName'))),
                        data: {
                            config: _.find(items, _.matchesProperty('__metadata.modelName', 'config')),
                            author: _.find(items, _.matchesProperty('__metadata.modelName', 'author'))
                        }
                    };
                }
            }
